...
```{r boxplot1, echo=FALSE, message=FALSE, warning=FALSE, fig.align='center'}
library(imager)
...
```{r boxplot2, echo=FALSE, message=FALSE, warning=FALSE, fig.align='center'}
...
```{r anova1, echo=FALSE, message=FALSE, warning=FALSE, fig.align='center'}
